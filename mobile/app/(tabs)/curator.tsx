 ...
 * - 3-column grid of liked tracks
 * - Floating staging area panel
...
import TrackGridItem, { GRID_GAP, GRID_PADDING, CARD_HEIGHT } from '../../components/curator/TrackGridItem';
import StagingArea from '../../components/curator/StagingArea';
        ...
        <View style={styles.container}>
            <SafeAreaView style={styles.safeArea} edges={['top']}>
                ...
                <View style={styles.sectionHeader}>
                    ...
                    <Text style={styles.sectionHint}>Hold to drag</Text>
                </View>
...
const styles = StyleSheet.create({
    ...
    gridContent: {
        ...
        paddingBottom: 200, // Space for staging area
    },
    emptyState: {
        alignItems: 'center',
        justifyContent: 'center',
